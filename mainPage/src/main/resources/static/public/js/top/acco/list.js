	    ...
	    // 정상적으로 검색이 완료됐으면 
	     if (status === kakao.maps.services.Status.OK) {
	        ...
	        kakao.maps.event.addListener(marker, 'click', function() {        
		        ...
		        '</div><div style="font-size:14px;margin:1px 10px 1px;"><span>'+phone+'</span><span style="margin:1px 10px 1px;"><a style="text-decoration:none;" href="/top/acco/detail/'+number+
