...
//값이 없을 때 submit 불가
const restUpdateForm = document.forms.restUpdateForm;
let tourist = restUpdateForm.tourist;
let address = restUpdateForm.address2;
let search = restUpdateForm.search;
restUpdateForm.addEventListener("submit", (event) => {
